...
import { Customer, Step5Data } from '@/types';

interface Step5Props {
  customer: Customer;
  stepData: Step5Data | null;
        ...
        <div className="flex gap-4">
          <label className="flex items-center gap-2">
            <input
              ...
              value="done"
              checked={formData.bank_verification === 'done'}
              onChange={(e) => setFormData({ ...formData, bank_verification: e.target.value as 'done' | 'no' })}
          ...
          <label className="flex items-center gap-2">
            <input
              ...
              name="bank_verification"
              value="no"
              checked={formData.bank_verification === 'no'}
              onChange={(e) => setFormData({ ...formData, bank_verification: e.target.value as 'done' | 'no' })}
              className="w-4 h-4 text-amber-600 focus:ring-amber-600"
            />
